...
class SpiderSpindleZ1TrayId(models.Model):
    """Stores tray IDs linked during Spider Spindle Z1 (IPS colors)."""
    ...
    class Meta:
        verbose_name = "Spider Spindle Z1 Tray"
        verbose_name_plural = "Spider Spindle Z1 Trays"
