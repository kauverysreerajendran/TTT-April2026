...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Jig_Loading', '__first__'),
        ('modelmasterapp', '0002_modelmaster_nickel_bath_type_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('spider_jig_qr_id', models.CharField(max_length=100)),
                ...
                ('spider_spindle_type', models.CharField(blank=True, help_text='Spider or Spindle type', max_length=20, null=True)),
                ('nickel_bath_type', models.CharField(blank=True, help_text='Nickel bath type', max_length=20, null=True)),
                ...
                ('spider_picked', models.BooleanField(default=False, help_text='Spider Jig has been picked and moved to completed table')),
                ('spider_picked_date_time', models.DateTimeField(blank=True, help_text='Date/Time when spider jig was picked', null=True)),
